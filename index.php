...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Silahkan absen terlebih dahulu</p>
  	...
  	if (isset($_GET['status'])) {
  		switch ($_GET['status']) {
  			...
  			case 'unidentified':
	    			...
	    			echo 	"Anda belum terdaftar di database kami, silahkan mendaftar.";
	    			echo "</div>";
  				break;
  			case 'sudah':
  					echo "<div class='alert alert-warning'>";
